  ...
  <div class="box">
    <div class="container">
      ...
      <div class="content">
        <h1>Vue入门</h1>
        <h4>基本环境配置</h4>
        <li>vue提供了操作文档：<a href="https://cli.vuejs.org/guide/deployment.html">https://cli.vuejs.org/guide/deployment.html</a></li>
        ...
        <yellow>避坑：入门不要选格式配置，否则打字慢的每打一个字都报一下错，不选不报错，下列步骤为不选</yellow>
